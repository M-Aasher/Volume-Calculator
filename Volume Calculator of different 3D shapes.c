...
Author: Aasher
Description: This program calculates the volume of a Cube, Cylinder, or Sphere based on user input using conditional statements.
Date: 31/10/2025
*/
...
if(choice==1){
    ...
    float length1, radius;
      ...
      scanf("%f", &radius);
    volume = 3.142 * length1 * radius * radius;
    ...
    float radius1;
      printf("Enter the radius:");
      scanf("%f", &radius1);
    volume = (4.0 / 3.0) * 3.142 * radius1 * radius1 * radius1;
